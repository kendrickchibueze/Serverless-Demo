...
// In the body of the connect function,
// the first action is to use the SignalR SDK to
// create a connection by calling HubConnectionBuilder.
// The result is a SignalR connection to the server.
